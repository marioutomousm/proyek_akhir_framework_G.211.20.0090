                        ...
                        <div class="col-lg-8 mt-3">
                            <form action="{{ url('/toko/store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kepala_toko" class="form-control" value="{{ old('kepala_toko')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlah_pekerja" class="form-control" value="{{ old('jumlah_pekerja')}}"></input>
